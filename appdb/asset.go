...
var AssetWhere = struct {
	...
	ProviderID:      whereHelperstring{field: "\"abb_free_at_home\".\"asset\".\"provider_id\""},
...
var (
	assetAllColumns            = []string{"id", "configuration_id", "project_id", "global_asset_id", "asset_type_name", "provider_id", "asset_id"}
	assetColumnsWithoutDefault = []string{"project_id", "global_asset_id", "asset_type_name", "provider_id"}
...
func (assetL) LoadConfiguration(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAsset interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`abb_free_at_home.configuration.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (assetL) LoadDatapoints(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAsset interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`abb_free_at_home.datapoint.asset_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Asset) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"abb_free_at_home\".\"asset\"", updateOnConflict, ret, update, conflict, insert, opts...)
