...
func (datapointAttributeL) LoadDatapoint(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDatapointAttribute interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args = append(args, object.DatapointID)
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if a == obj.DatapointID {
					continue Outer
				}
			}

			args = append(args, obj.DatapointID)
	...
	query := NewQuery(
		...
		qm.WhereIn(`abb_free_at_home.datapoint.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *DatapointAttribute) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *DatapointAttribute) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"abb_free_at_home\".\"datapoint_attribute\"", updateOnConflict, ret, update, conflict, insert)
